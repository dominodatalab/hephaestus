...
require (
	...
	github.com/dominodatalab/controller-util v0.1.4
	...
	github.com/tonistiigi/fsutil v0.0.0-20250408213759-5512fa194537
...
replace google.golang.org/grpc/stats/opentelemetry => google.golang.org/grpc v1.69.4
