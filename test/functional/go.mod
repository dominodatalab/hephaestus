...
replace k8s.io/kube-openapi v0.0.0-20220328201542-3ee0da9b0b42 => k8s.io/kube-openapi v0.0.0-20211115234752-e816edb12b65

require (
	github.com/dominodatalab/testenv v0.0.0-20221006225544-954236653900
...
require (
	...
	github.com/helmfile/helmfile v0.146.0 // indirect
