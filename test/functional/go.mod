...
replace (
	...
	github.com/docker/cli => github.com/docker/cli v26.0.2+incompatible
...
require (
	...
	github.com/dominodatalab/testenv v0.0.0-20240408211430-98234478379c
...
require (
	...
	github.com/helmfile/chartify v0.17.0 // indirect
	github.com/helmfile/helmfile v0.161.0 // indirect
	github.com/helmfile/vals v0.33.0 // indirect
