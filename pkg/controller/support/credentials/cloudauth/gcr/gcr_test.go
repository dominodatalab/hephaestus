...
func TestAuthenticate(t *testing.T) {
	...
	ctxCanceledErr := errors.New(fmt.Sprintf("request to access GCR registry token failed with Error: Get \"http://oauth2accesstoken:***@%s?client_id=forge&service=serviceName\": context canceled", tsAddress.String()))
